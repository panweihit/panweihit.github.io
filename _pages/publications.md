...
I publish and review papers in major venues spanning several areas: Control (e.g., IEEE TAC, Automatica), Machine Learning (e.g., NeurIPS, ICML, ICLR), and Robotics (e.g., IEEE TRO, IEEE RAL, CoRL, ICRA, IROS).
